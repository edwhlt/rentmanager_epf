...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Voitures
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/cars/edit">Ajouter</a>
            </h1>
        </section>
                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${vehicles}" var="vehicle">
                                    ...
                                    <td>
                                        ...
                                        <form action="${pageContext.request.contextPath}/cars" method="post" style="display: inline-block;">

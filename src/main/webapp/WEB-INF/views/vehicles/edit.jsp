            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <!-- /vehicles/create -->
                        <form class="form-horizontal" action="/../rentmanager/cars/edit" method="post">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="manufacturer" name="manufacturer" placeholder="Marque" required value=${manufacturer}>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="modele" name="modele" placeholder="Modele" value=${modele}>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="seats" name="seats" placeholder="Nombre de places" required value=${seats}>
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">

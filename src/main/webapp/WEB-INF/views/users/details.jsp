                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <h3 class="profile-username text-center">${user.getFirstName()} ${user.getLastName()} (${user.getEmail()})</h3>
                            ...
                            <ul class="list-group list-group-unbordered">
                                ...
                                <li class="list-group-item">
                                    <b>Voiture(s)</b> <a class="pull-right">${vehicules.size()}</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.box-body -->
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach var="reserv"  items="${requestScope['reservations']}" >
                                            <tr>
                                                <td>${reserv.id}</td>
                                                <td>${vehicules.get(reserv.vehicleId).constructor}</td>
                                                <td>${reserv.start}</td>
                                                <td>${reserv.end}</td>
                                            </tr>
                                        </c:forEach>
                            ...
                            <div class="tab-pane" id="cars">
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach var="vehicle"  items="${vehicles.values()}" >
                                            <tr>
                                                <td>${vehicle.id}</td>
